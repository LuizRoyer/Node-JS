...
describe('Account Mongo Repository', () => {
    ...
    test('Should return an account on add sucess', async () => {
        ...
        expect(account).toBeTruthy()// valida se nao é nulo ou undefined
    ...
    test('Should return null if loadByEmail fails', async () => {
        const sut = makeSut()
        const account = await sut.loadByEmail('any_email@email.com')
        expect(account).toBeFalsy()// valida se nao é nulo ou undefined
    })

    test('Should update  the account accessToken sucess', async () => {
        const sut = makeSut()
